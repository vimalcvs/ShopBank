...
public class Cart  extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        webView.loadUrl("https://shopbank.wooplr.com/checkout/cart");
    }
    public void init() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent intent = new Intent(Cart.this,ActivitySample.class);
            startActivity(intent);
            return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(Cart.this,men.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(Cart.this,International.class);
            startActivity(intent);
        } else if (id == R.id.nav_collection) {
            Intent intent = new Intent(Cart.this,Collection.class);
            startActivity(intent);
        } else if (id == R.id.nav_cart) {
            Intent intent = new Intent(Cart.this,Cart.class);
            startActivity(intent);
        } else if (id == R.id.nav_offer) {
            Intent intent = new Intent(Cart.this,Offer.class);
            startActivity(intent);
