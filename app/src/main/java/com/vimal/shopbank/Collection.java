...
public class Collection extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        webView.loadUrl("https://shopbank.wooplr.com/c/shop-collections");
    }
    public void init() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent intent = new Intent(Collection.this,ActivitySample.class);
            startActivity(intent);
            return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(Collection.this,men.class);
            startActivity(intent);
