 ...
 */
public class Offer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Offer.this,Cart.class);
        ...
        init();
        webView.loadUrl("https://shopbank.wooplr.com/check-order-status");
    }
    public void init() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent intent = new Intent(Offer.this,ActivitySample.class);
            startActivity(intent);
            return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(Offer.this,men.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(Offer.this,International.class);
            startActivity(intent);
        } else if (id == R.id.nav_collection) {
            Intent intent = new Intent(Offer.this,Collection.class);
            startActivity(intent);
        } else if (id == R.id.nav_cart) {
            Intent intent = new Intent(Offer.this,Cart.class);
            startActivity(intent);
        } else if (id == R.id.nav_offer) {
            Intent intent = new Intent(Offer.this,Offer.class);
            startActivity(intent);
