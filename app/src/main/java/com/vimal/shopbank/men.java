 ...
 */
public class men extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        webView.loadUrl("https://shopbank.wooplr.com/?search=true");
    }
    public void init() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent intent = new Intent(men.this,ActivitySample.class);
            startActivity(intent);
            return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(men.this,men.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(men.this,International.class);
            startActivity(intent);
        } else if (id == R.id.nav_collection) {
            Intent intent = new Intent(men.this,Collection.class);
            startActivity(intent);
        } else if (id == R.id.nav_cart) {
            Intent intent = new Intent(men.this,Cart.class);
            startActivity(intent);
        } else if (id == R.id.nav_offer) {
            Intent intent = new Intent(men.this,Offer.class);
            startActivity(intent);
